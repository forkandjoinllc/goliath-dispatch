...
/**
 * See `equipment/_components/date-only-field.tsx` for why this is a plain
 * `<input type="date">` rather than the design system's calendar
 * `DatePicker` — same rationale, duplicated locally rather than imported
 * across route groups.
 */
