...
interface Props {
  ...
  can: { update: boolean; changeStatus: boolean }
}
...
export default function EquipmentShow({ type, unit, loads, can }: Props) {
  ...
  return (
    ...
    >
      ...
      {/* El motivo de estar fuera de servicio, arriba. Es lo que explica por qué
