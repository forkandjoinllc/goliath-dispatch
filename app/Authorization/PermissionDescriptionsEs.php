...
final class PermissionDescriptionsEs
{
    ...
    public const ALL = [
        ...
        'vendor:read' => 'Ver proveedores y sus contactos',
        'vendor:create' => 'Crear un proveedor',
        'vendor:update' => 'Editar un proveedor o un contacto suyo',
        'vendor:delete' => 'Borrar un proveedor (borrado suave)',
